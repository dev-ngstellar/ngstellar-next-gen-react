...
const SERVICE_ID = "service_bchcoj9";
const TEMPLATE_ID = "template_2zxv2sh";
const PUBLIC_KEY = "DVdr_KyFYc3l9t1_K";
...
function Contact() {
    ...
    return (
        <section className="py-32 md:py-20">
            ...
            <div className="mx-auto max-w-6xl px-4 sm:px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
                ...
                <div>
                    ...
                    <div className="mt-6 md:mt-10 space-y-3">
                        <h3 className="text-base sm:text-lg font-semibold text-white flex items-center gap-2">
                            <FaMapLocationDot className="text-lg sm:text-xl text-fuchsia-400" />
                            Our Location
                        </h3>
                        ...
                        {/* Map Box */}
                        <div className="w-full h-48 sm:h-56 md:h-64 rounded-xl overflow-hidden shadow-lg border border-white/10">
                            <iframe
