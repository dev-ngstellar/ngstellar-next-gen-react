            ...
            <div className="relative w-full py-24 md:py-32 overflow-hidden bg-[#020617]">
                ...
                <div className="relative max-w-7xl mx-auto px-6 md:px-20 z-10 text-center md:text-left">
                    <h1 className="text-4xl md:text-6xl font-black text-white tracking-tight mb-4">
                        Privacy <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 via-fuchsia-300 to-rose-300">Policy</span>
                    </h1>
                ...
                <div className="bg-slate-900/80 backdrop-blur-md border border-slate-800 rounded-2xl p-8 md:p-12 text-slate-300 shadow-2xl">
                    ...
                    <div className="space-y-10">
                        ...
                        <section>
                            ...
                            <p>You may access, update, or request deletion of your personal data. Contact us at <a href="mailto:email@ngstellar.com" className="text-fuchsia-400 hover:text-fuchsia-300 underline">email@ngstellar.com</a>.</p>
                        </section>
