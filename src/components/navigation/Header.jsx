      ...
      <div className="relative w-full h-[64px] sm:h-[68px] lg:h-[74px] flex items-center justify-between px-3 sm:px-4 lg:px-6">
        ...
        <div className="flex-shrink-0 flex items-center gap-2">
          ...
          <button
            ...
            className="md:hidden p-2 rounded-xl text-slate-200 hover:text-white bg-white/[0.06] hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-primary-500/50"
