...
function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden pt-16 pb-8" style={{ background: 'linear-gradient(90deg, #1e325f 0%, #7db941 100%)' }}>
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col items-center text-center">
        ...
        <div className="mb-6">
          <Link to="/">
             <img src="/logo_ngs.png" alt="NG Stellar Solutions" className="h-12 w-auto" />
          </Link>
        </div>
