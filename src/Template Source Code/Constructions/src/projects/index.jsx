  ...
  return (
    <div className="w-full pt-24">
      ...
      <section className="relative py-20 bg-slate-900 text-white text-center">
        <div className="absolute inset-0 bg-cover bg-center opacity-30" style={{ backgroundImage: `url(${getImg('projects.infrastructure01')})` }} />
        <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-black mt-4 tracking-tight">
