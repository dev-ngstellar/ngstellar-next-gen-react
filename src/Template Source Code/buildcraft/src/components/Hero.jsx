...
export default function Hero() {
  ...
  // Track mouse coordinates for subtle parallax on the image card
  useEffect(() => {
  ...
  return (
    ...
    >
      {/* Background elegant corporate gradients */}
        ...
        <div className="lg:col-span-6 flex flex-col justify-center" style={{ width: '100%' }}>
          ...
          >
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full bg-[#F59E0B]/10 border border-[#F59E0B]/20 text-[#F59E0B] font-bold uppercase text-[10px] tracking-[0.2em] select-none">
              <Sparkles size={11} className="text-[#F59E0B] animate-pulse" />
              Dubai Mega Projects
            </div>
          </motion.div>
          ...
          {/* Heading */}
          <motion.h1 
            className="font-black uppercase tracking-tight text-[#0F172A]"
            style={{ 
          ...
          >
            ...
            <span className="bg-gradient-to-r from-[#F59E0B] to-[#D97706] bg-clip-text text-transparent">Of Modern Cities</span>
          </motion.h1>

          {/* Description */}
          <motion.p 
            className="text-[#64748B] font-light"
            style={{ 
              marginTop: '32px',
              marginBottom: '48px', 
              maxWidth: '600px',
          ...
          >
            Delivering iconic residential, commercial and infrastructure developments engineered for generations.
          </motion.p>
          ...
          >
            <a 
              ...
              className="btn btn-primary btn-shimmer !bg-[#F59E0B] !text-[#0F172A] !border-[#F59E0B] font-bold hover:!bg-transparent hover:!text-[#F59E0B]"
            >
              View Projects
            </a>
            <a 
          ...
          >
            <div className="flex flex-col">
              <span className="text-3xl font-extrabold text-[#0F172A]">500+</span>
              <span className="text-[10px] uppercase tracking-widest text-[#F59E0B] font-bold mt-1">Projects</span>
            </div>
            <div className="flex flex-col">
              <span className="text-3xl font-extrabold text-[#0F172A]">25+</span>
              <span className="text-[10px] uppercase tracking-widest text-[#F59E0B] font-bold mt-1">Years</span>
            </div>
            <div className="flex flex-col">
              <span className="text-3xl font-extrabold text-[#0F172A]">50M+</span>
              <span className="text-[10px] uppercase tracking-widest text-[#F59E0B] font-bold mt-1">Sq Ft Delivered</span>
            </div>
          </motion.div>
        ...
        <div className="lg:col-span-6 relative flex justify-center items-center">
          ...
          >
            <img 
              ...
              alt="Dubai skyscraper construction"
